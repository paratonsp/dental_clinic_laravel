                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            ...
                            <span>Obat Keluar Hari ini</span>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            <h2 class="fs-34 text-black font-w600">
                                {{$query->totalObatKeluarSum()}}
                            </h2>
                            <span>Total Obat Keluar</span>
                            <span>  {{$query->totalObatKeluar()}} Jenis
                            </span>
                        </div>
                        {{-- <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-xl-12">	
                    <div class="card appointment-schedule">
                        <div class="card-header pb-0 border-0">
                            <h3 class="fs-20 text-black mb-0">Permintaan Obat</h3>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-xxl-12  col-md-12 dz-scroll">
                                    <div id="obat-list-notif">
                                        @if ($query->permintaanObat()->count() > 0)
                                            @foreach ($query->permintaanObat() as $item)
